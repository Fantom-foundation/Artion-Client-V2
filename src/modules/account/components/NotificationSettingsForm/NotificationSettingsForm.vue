...
export default {
    ...
    // watch: {
    //     yourActivity(value) {
    //         console.log('yourActivity: ', value)
    //         if(!value) {
    //             this.oldValues = clone(this.values);
    //             Object.keys(sNotifications()).forEach(name => {
    //                 //this.values[name] = false;
    //                 this.$set(this.values, name, false);
    //             });
    //         }
    //     }
    // },
        ...
        async onFormSubmit(data) {
            ...
            if (ok) {
                ...
                if (!this.followerActivity) {
                    Object.keys(fNotifications()).forEach(name => {
                        //this.values[name] = false;
                        this.$set(this.values, name, false);
                    });
                }
